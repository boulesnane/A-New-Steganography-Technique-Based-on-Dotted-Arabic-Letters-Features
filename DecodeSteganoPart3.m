...
%-------------------------------------------------------------------------
function [covertext, originaltext] = DecodeSteganoPart3(steganotext,mappingtable)
clc
bits = 6;
kashidadec = 1600;
        ...
        if findit == false
            if  steganotext(j+stp+1)==kashidadec
                if steganotext(j+stp+2)==kashidadec
                    ...
                    [bitsseries] = getbits(originaltextbits, steganotext, j)
                    
                    stopcount=0;
                    steganotext(j+stp+1)=[];
                    originaltextbits=[originaltextbits bitsseries];
