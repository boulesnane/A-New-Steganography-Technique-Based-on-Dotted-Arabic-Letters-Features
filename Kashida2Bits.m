...
%-------------------------------------------------------------------------
function [steganotext1,mappingtable, Stegobitsused,Secretbits] = Kashida2Bits(covertext, secrettext)
clc
    ...
    while j <= length(steganotext1)-1
        ...
        if value == 1
            ...
            if findit == false
                ...
                if (ismember(char(steganotext1(j)), tp) || ismember(char(steganotext1(j)), bp)) &&  (ismember(char(steganotext1(j+1)), tp) || ismember(char(steganotext1(j+1)), bp)) && strcmp(strrep(secrtbits(i:i+3),' ',''),'00')
                    Stegobitsused = Stegobitsused + 2;
                    histoBits =[histoBits 2];
                    steganotext1 =[steganotext1(1:j+stp)  kashidadec steganotext1(j+stp+1:length(steganotext1))];
                    j= j+1;
                    i=i+4;
                    break;
                    
                elseif (ismember(char(steganotext1(j)), tp) || ismember(char(steganotext1(j)), bp)) &&  (ismember(char(steganotext1(j+1)), np)) && strcmp(strrep(secrtbits(i:i+3),' ',''),'01')
                    Stegobitsused = Stegobitsused + 2;
                    histoBits =[histoBits 2];
                    steganotext1 =[steganotext1(1:j+stp)  kashidadec steganotext1(j+stp+1:length(steganotext1))];
                    j= j+1;
                ...
                elseif ismember(char(steganotext1(j)), np) &&  ismember(char(steganotext1(j+1)), np) && strcmp(strrep(secrtbits(i:i+3),' ',''),'10')
                    Stegobitsused = Stegobitsused + 2;
                    histoBits =[histoBits 2];
                    steganotext1 =[steganotext1(1:j+stp)  kashidadec steganotext1(j+stp+1:length(steganotext1))];
                    j= j+1;
                ...
                elseif ismember(char(steganotext1(j)), np) &&  (ismember(char(steganotext1(j+1)), tp) || ismember(char(steganotext1(j+1)), bp)) && strcmp(strrep(secrtbits(i:i+3),' ',''),'11')
                    Stegobitsused = Stegobitsused + 2;
                    histoBits =[histoBits 2];
                    steganotext1 =[steganotext1(1:j+stp)  kashidadec steganotext1(j+stp+1:length(steganotext1))];
                    j= j+1;
